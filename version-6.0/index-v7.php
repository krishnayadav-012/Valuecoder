...
<html lang="en">
  <head>
    ...
    <link rel="preload stylesheet" type="text/css" href="./css/index-v7.css" defer />
  ...
  <body>
    <?php require_once './include/menu-v7.php'; ?>
    <section class="hero-section">
      ...
      <div class="container">
        <div class="dis-flex">
          <div class="left-box">
            <h1><strong>Scale Your Engineering Team & Software Delivery -</strong> Without Compromise</h1>
            <p>We are an award-winning Indian software engineering company focused on providing outsourced software development and software engineering teams to our clients globally. 
            </p>
        ...
        <div class="award-image">
          <div class="dis-flex">
            ...
            <div class="award-section">
              <picture>
                <source type="image/webp" srcset="images/home-images/award-image.png">
                <img loading="lazy" src="images/home-images/award-image.png"width="1200" height="185">
              </picture>
            </div>
          </div>
        </div>
    ...
    <section class="work-with">
      <div class="container">
        <div class="top-section">
          <h2>We Work With</h2>
          <p>
            Startups, enterprises, and agencies to add more value to their tech portfolio and improve the bottom line<br>
            with custom software engineering and IT solutions.
          </p>
        </div>
        <div class="work-cards">
          <div class="card">
            <div class="card-image">
              <picture>
                <source type="image/webp" srcset="images/home-images/work-01.png">
                <img loading="lazy" src="images/home-images/work-01.png"width="335" height="215">
              </picture>
            </div>
    ...
    <section class="what-we-offer padding-t-120 padding-b-120">
      <div class="container">
        <div class="top-section">
          <h4><span>What we offer</span></h4>
          <h2>Software Development & Engineering Services</h2>
          <p>
            Driven by the top 1% of software engineering talent in India, we deliver robust, scalable, and reliable<br> software product solutions to clients across the globe.
          </p>
        </div>
        <div class="work-cards">
          <div class="card">
            <div class="card-image">
              <picture>
                <source type="image/webp" srcset="images/home-images/icon-01.png">
                <img loading="lazy" src="images/home-images/icon-01.png"width="39" height="39">
              </picture>
            </div>
            <div class="card-content">
              <h3>AI & ML</h3>
              <p>
                Embrace AI & ML to drive innovation and efficiency in your business. Our customized solutions offer advanced insights and automation, enabling streamlined processes.
              </p>
              <a href="#" class="is-arrow">Learn More</a>
            </div>
          </div>
            ...
            <div class="glider">
              ...
              <div class="test-row">
                <picture>
                  ...
                  <img loading="lazy" src="images/images/home-images/clinet-01.png" alt="Valuecoders" width="290" height="328">
                </picture>
              </div>
              <div class="test-row">
                <div class="vid-wrap">
                  <div class="client-videos" id="cvbox-1">
                    <div class="client-video-box">
                      ...
                      <a class="frame-mask" href="javascript:void(0);" onclick="playTetiVideo(1, 'https://www.youtube.com/embed/aErqOtvMClY?autoplay=1', this)">
                        <picture>
                          <source type="image/png" srcset="images/home-images/clinet-02.png">
                          <img loading="lazy" src="images/home-images/clinet-02.png" alt="Valuecoders" width="290" height="328">
                        </picture>
                        <div class="playBtn">
              ...
              <div class="test-row">
                <picture>
                  <source type="image/png" srcset="images/home-images/clinet-03.png">
                  <img loading="lazy" src="images/images/home-images/clinet-03.png" alt="Valuecoders" width="290" height="328">
                </picture>
              </div>
              <div class="test-row">
                <div class="vid-wrap">
    ...
    <div class="popup-section">
      <div id="intentPopup" class="popup-wrapper" style="display:none">
        <div class="popWrap">
          <div class="popup-content">
            <span class="closeicon">
            <img loading="lazy" src="images/cross-image.svg" alt="Valuecoders" width="11" height="11"></span>
            <h2>Stay With Us</h2>
            ...
            <div class="ctasec">
              ...
              <a href="javascript:void(0);" class="subscribe-btn">Subscribe to our newsletter</a>
            </div>
          </div>
        </div>
      </div>
