        ...
        <nav class="menu mob-nav" id="menu">
          <ul>
                            ...
                            <div class="flex-2">
                              ...
                              <div class="double-menu sub-service">
                                <div class="menu-box">
                                  ...
                                  <a class="top-head" href=""> <span class="title"><img loading="lazy" src="header-images/notab-ser01.svg" class="menuicon" alt="menuicon">
                                  Cybersecurity Services</span></a>
                                  <a href="#">
                                  Penetration Testing</a>
                                  <a href="#">
                                  Security Audit Services</a>
                                  <a class="top-head" href=""> <span class="title"><img loading="lazy" src="header-images/notab-ser01.svg" class="menuicon" alt="menuicon">
                                  Enterprise Platform Development</span></a>
                                  <a href="#">
                                  Salesforce Development</a>
                                  <a href="#">
                                  Service Now Development</a>
                                  <a href="#">
                                  Microsoft Power Platform</a>
                                  <a href="#">
                                  Microsoft Power Platform</a>
                                  <a href="#">
                                  Microsoft Dynamics Development</a>
                                  <a href="#">
                                  SAP Development Services</a>
                                  <a href="#">
                                  Oracle Development Services</a>
                                </div>
                                <div class="menu-box">
                                  <a class="top-head" href=""> <span class="title"><img loading="lazy" src="header-images/notab-ser01.svg" class="menuicon" alt="menuicon">
                                  Data Engineering & Analytics</span></a>
                                  <a href="#">
                                  Business Intelligence Services</a>
                                  <a class="top-head" href=""> <span class="title"><img loading="lazy" src="header-images/notab-ser01.svg" class="menuicon" alt="menuicon">
                                  Integration & API Services</span></a>
                                  <a href="#">
                                  API Development Services</a>
                                  <a href="#">
                                  System Integration Services</a>
                                  <a class="top-head" href=""> <span class="title"><img loading="lazy" src="header-images/notab-ser01.svg" class="menuicon" alt="menuicon">
                                  Cloud & DevOps Services</span></a>
                                  <a href="#">
                                  DevOps Automation Services</a>
                                  <a href="#">
                                  Cloud Migration Services</a>
                                  <a class="top-head" href=""> <span class="title"><img loading="lazy" src="header-images/notab-ser01.svg" class="menuicon" alt="menuicon">
                                  IoT Development Services</span></a>
                                  <a class="top-head" href=""> <span class="title"><img loading="lazy" src="header-images/notab-ser01.svg" class="menuicon" alt="menuicon">
                                  Blockchain Development Services</span></a>
                                </div>
                              </div>
                            </div>
                            <div class="flex-4">
            ...
            <li class="menu-item-has-children">
              ...
              <div class="menu-mega solution-menu">
                <div class="container">
                  <div class="dis-flex tab-menu">
                        ...
                        <div class="tab-content">
                          <div class="dis-flex menu-column">
                            ...
                            <div class="flex-5 comp-logo">
                              ...
                              Security & Compliance</span></a>
                              <p>We take your data security seriously. </p>
                              <img loading="lazy" src="header-images/certified-logo.svg" class="menuicon" alt="Certified Logo">
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div id="mnu-tech" class="dis-flex tab-contents">
                    <div class="right-tabs">
                      <div class="tab-content">
                        <div class="dis-flex menu-column">
                          <div class="flex-1">
                            <a class="top-head p0" href=""> <span class="title"><img loading="lazy" src="header-images/notab-ser01.svg" class="menuicon" alt="menuicon">
                            FinTech & Financial Services</span>Custom Software Development</a>
                            <a class="top-head" href=""> <span class="title"><img loading="lazy" src="header-images/notab-ser01.svg" class="menuicon" alt="menuicon">
                            SaaS & Technology Platforms</span>Custom Software Development</a>
                            <a class="top-head" href=""> <span class="title"><img loading="lazy" src="header-images/notab-ser01.svg" class="menuicon" alt="menuicon">
                            Media & Entertainment Technology</span>Custom Software Development</a>
                            <a class="top-head" href=""> <span class="title"><img loading="lazy" src="header-images/notab-ser01.svg" class="menuicon" alt="menuicon">
                            Healthcare & Medical Technology</span>Custom Software Development</a>
                            <a class="top-head" href=""> <span class="title"><img loading="lazy" src="header-images/notab-ser01.svg" class="menuicon" alt="menuicon">
                            E-commerce & Retail Solutions</span>Custom Software Development</a>
                            <a class="top-head" href=""> <span class="title"><img loading="lazy" src="header-images/notab-ser01.svg" class="menuicon" alt="menuicon">
                            Education & EdTech Solutions</span>Custom Software Development</a>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="tab-content">
                        <div class="dis-flex menu-column">
                          <div class="flex-2">
                            ...
                            Company</span></a>
                            <a href="#">
                            Our Development & Methodology</a>
                            <a href="#">
                            Success Stories & Case Studies</a>
                            <a href="#">
                            Partnerships & Certifications</a>
                            <a href="#">
                            Careers & Company Culture</a>
                            <a href="#">
                            Contact Us & Global Offices</a>
                          </div>
                          <div class="flex-2">
                            <a class="top-head p0" href=""> <span class="title"><img loading="lazy" src="header-images/notab-ser01.svg" class="menuicon" alt="menuicon">
                            Resources</span></a>
            ...
            <li class="menu-item-has-children">
              <a href="#">Pricing</a> <span class="arrow-btn"></span>
              <div class="menu-mega small-menu pricing-menu">
                <div class="dis-flex tab-menu">
                  <div id="mnu-tech" class="dis-flex tab-contents">
                    <div class="right-tabs">
                      <div class="tab-content">
                        <div class="dis-flex menu-column">
                          ...
                          <div class="flex-3">
                            <a class="top-head p0" href=""> <span class="title"><img loading="lazy" src="header-images/notab-ser01.svg" class="menuicon" alt="menuicon">
                            Pricing Guides</span></a>
                            <a href="#">
                            Hourly Rates by Country</a>
                            <a href="#">
                            Fixed vs Hourly</a>
                            <a href="#">
                            Cost Comparisons</a>
