        ...
        <div class="wrapper">
            <div class="header-item-left">
                <a href="<?php echo $site_url; ?>" class="brand">
					<img loading="lazy" src="<?=HOST_URL?>images/logo.png" alt="Logo" class="dark-theme-logo" width="301" height="52">
                    <img loading="lazy" src="<?=HOST_URL?>images/logo-blue.png" alt="Logo" class="day-theme-logo" width="301" height="52">
                </a>
            </div>
            <!-- Navbar Section -->
                                ...
                                <div class="container">
                                    <div class="dis-flex" id="active_Current_Tabs1">
                                        <div class="width-25 left-list">
                                            <a href="<?php echo $site_url; ?>hire-developers" class="text-column active cursor-pointer" id="a0"  data-section="active_Current_Tabs1" data-mrow="0">Hire Software Developers</a>
                                            <a href="#" class="text-column" id="a1" data-section="active_Current_Tabs1" data-mrow="1">Smart Teams</a>
                                        ...
                                        <!-- hire tech -->
                                        <div class="width-75 header-menu active" id="b0">
                                            <div class="dis-flex last-list" id="active_Current_Tabs0">
                                                ...
                                                <div class="width-25 last-list">
                                                    ...
                                                    <a href="<?php echo $site_url; ?>hire-developers/hire-mobile-app-developers" class="margin-t-40"><strong>Mobile</strong></a>
                                                ...
                                                <div class="width-25 last-list">
                                                    <a href="<?php echo $site_url; ?>hire-developers/hire-blockchain-developers"><strong>Blockchain</strong></a>
                                                ...
                                                <div class="width-25 last-list">
                                                    ...
                                                    <a href="<?php echo $site_url; ?>hire-developers/hire-machine-learning-experts" class="margin-t-40"><strong>ML</strong></a>
                                                    ...
                                                    <a href="<?php echo $site_url; ?>low-code-no-code-services" class="margin-t-40"><strong>Lowcode</strong></a>
                                        ...
                                        <!-- 1 -->
                                        <div class="width-75 header-menu" id="b1">
                                            <div class="dis-flex" id="active_Current_Tabs2">
                                                <div class="width-40 middle-list">
                                                    ...
                                                    <a href="<?php echo $site_url; ?>benefits-of-hiring-remote-workers" class="text-column" id="a27" data-section="active_Current_Tabs2">Hiring Locally</a>
...
<header class="header-mobile header-two">
    <div class="container">
		<div class="header-top">
			<a href="https://www.valuecoders.com" class="mobile-logo">
				<img loading="lazy" src="<?=HOST_URL?>images/logo.png" alt="Logo" class="logo dark-theme-logo" width="301" height="52">
				<img loading="lazy" src="<?=HOST_URL?>images/logo-blue.png" alt="Logo" class="logo day-theme-logo" width="301" height="52">
			</a>
		...
		<nav class="mob-nav">
			<div class="menu-list first" id="dropdownmwrap1">
				...
				<ul>
					...
					<!-- <li><a href="#">Pricing</a> <span class="arrow-btn" onclick="innermenu(this, 'main1')"></span>
			...
			<div class="menu-list second" id="dropdownmwrap">
				...
				<ul>
                    <li><a href="<?php echo $site_url; ?>hire-developers">Hire Software Developers</a> <span class="arrow-btn" onclick="innermenu(this, 'main0')"></span>
						<div class="first-inner hire-title" id="main0">
                            ...
                            <div>
                                <a href="<?php echo $site_url; ?>low-code-no-code-services" class="margin-t-40">Lowcode</a> <span class="arrow-btn" onclick="innermenu(this, 'main10')"></span>
					...
					<li><a href="#">Smart Team</a> <span class="arrow-btn" onclick="innermenu(this, 'inner1')"></span>
                        <div class="inner-list" id="inner1">
                            ...
                            <a href="<?php echo $site_url; ?>benefits-of-hiring-remote-workers">Hiring Locally</a>
                            <!-- <a href="#">Rate Card</a> -->
