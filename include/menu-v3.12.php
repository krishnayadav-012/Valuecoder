<?php
  ...
  */
  ...
  $pcatArray = [
    ...
    'data-science' => ['name' => 'Data Science & AI', 'slug' => 'data-science', 'icon' => 'data-science.svg' ]
  ];
        ...
        <nav class="menu mob-nav" id="menu">
          ...
          <ul>
                ...
                <div class="container landing-menu" id="landing-menu">
                  <div class="dis-flex">
                    <div class="flex-3">
                      ...
                      <a href="<?php echo $site_url; ?>hire-developers"><img src="<?php echo $tpl_url; ?>/menu-images/service_icon2.svg" class="menuicon" alt="menuicon"><span class="title">On-demand Software Teams</span>
                      Get in-house pre vetted software developers, timesheet based billing</a>
                      ...
                      <a href="<?php echo $site_url; ?>devops-consulting-engineering-services-company"><img src="<?php echo $tpl_url; ?>/menu-images/devops-icon.svg" class="menuicon" alt="menuicon"><span class="title">DevOps</span>
                      Build high-quality software faster with DevOps</a>
                      <!-- 
                        <a href="<?php echo $site_url; ?>ai-ml-development-services-company"><img src="<?php echo $tpl_url; ?>/menu-images/aiml-icon.svg" class="menuicon" alt="menuicon"><span class="title">AI/ML</span>
                    ...
                    <div class="flex-3">
                      ...
                      End-to-end mobile, web, front-end, back-end application development</a>
                      ...
                      Consulting, B2B & B2C solutions, digital marketing & more</a>
                      <!-- 
                        <a href="<?php echo $site_url; ?>business-intelligence-consulting-services"><img src="<?php echo $tpl_url; ?>/menu-images/service_icon6.svg" class="menuicon" alt="menuicon"><span class="title">Analytics</span>
                        Business Intelligence, custom dashboard</a> 
                        -->
                        <a href="<?php echo $site_url; ?>data-science"><img src="<?php echo $tpl_url; ?>/menu-images/data-science.svg" class="menuicon" alt="menuicon"><span class="title">Data Science & AI</span>
                        Accelerate growth with data science services</a>
                    </div>
                    <div class="flex-3">
                      ...
                      Achieve business goals with custom software product development</a>
                      ...
                      Automate processes with end-to-end solutions</a>
                ...
                <div class="container w-14 prod-eng" id="m-product-engineering">
                  <div class="dis-flex">
                    ...
                    <div class="flex-3">  
                      ...
                      Empowering businesses with scalable SaaS solutions</a>
               ...
               <!-- <div class=" container w-14 landing-menu analytics" id="m-analytics-old-na">
                  <div class="dis-flex">
                    ...
                    <div class="flex-3">
                      ...
                      <a href="<?php echo $site_url; ?>amazon-aws-partner-company-india"><img src="<?php echo $tpl_url; ?>/menu-images/devop-analyt-icon6.svg" class="menuicon" style="left:-5px" alt="menuicon"><span class="title">Amazon AWS</span>
                      Seamless development and deployment of AWS cloud applications</a>
                    </div>
                  </div>
                </div>-->

                <div class=" container landing-menu devops" id="m-analytics">
                  <div class="dis-flex">
                    <div class="flex-3">
                       <a href="<?php echo $site_url; ?>amazon-aws-partner-company-india"><img src="<?php echo $tpl_url; ?>/menu-images/devop-analyt-icon6.svg" class="menuicon" alt="menuicon" style="left:-5px"><span class="title">Amazon Aws</span>
                     </a>
                      <a href="<?php echo $site_url; ?>microsoft-azure-partner-company-india"><img src="<?php echo $tpl_url; ?>/menu-images/devops-02.svg" class="menuicon" alt="menuicon"><span class="title">Azure</span>
                     </a>
                    </div>
                  </div>
                </div>
                ...
                <div class="dis-flex">
                <div class="flex-3">
                <span class="head">Data Analytics</span>
                <a href="<?php echo $site_url; ?>business-intelligence-consulting-services"><img src="<?php echo $tpl_url; ?>/menu-images/ds-01.svg" class="menuicon" alt="menuicon"><span class="title">BI Consulting</span>
                Unleash the power of data analytics & BI</a>
                <a href="<?php echo $site_url; ?>bi-implementation"><img src="<?php echo $tpl_url; ?>/menu-images/ds-02.svg" class="menuicon" alt="menuicon"><span class="title">BI Implementation</span>
                Transforming data into insights</a>
                <a href="<?php echo $site_url; ?>big-data-application-development-services-company"><img src="<?php echo $tpl_url; ?>/menu-images/ds-03.svg" class="menuicon" alt="menuicon"><span class="title">Big Data</span>
                Harness the potential of big data</a>
                <a href="<?php echo $site_url; ?>microsoft-power-bi-development-services-company"><img src="<?php echo $tpl_url; ?>/menu-images/ds-04.svg" class="menuicon" alt="menuicon"><span class="title">Microsoft Power BI</span>
                Empower your business with Microsoft Power BI</a>
                <a href="<?php echo $site_url; ?>data-analytics"><img src="<?php echo $tpl_url; ?>/menu-images/ds-06.svg" class="menuicon" alt="menuicon"><span class="title">Data Analytics</span>
                Driving success through data</a>
                </div>
                <div class="flex-3 bg-light">
                <span class="head">AI & ML</span>
                <a href="<?php echo $site_url; ?>chatbot-development-company"><img src="<?php echo $tpl_url; ?>/menu-images/ds-05.svg" class="menuicon" alt="menuicon"><span class="title">Chatbots</span>
                Enhance customer experience with Chatbots</a>
                <a href="<?php echo $site_url; ?>data-science-consulting-services"><img src="<?php echo $tpl_url; ?>/menu-images/ds-10.svg" class="menuicon" alt="menuicon"><span class="title">Data science Consulting</span>
                Make data-driven decisions for success</a>
                <a href="<?php echo $site_url; ?>rpa-development-services-company"><img src="<?php echo $tpl_url; ?>/menu-images/ds-07.svg" class="menuicon" alt="menuicon"><span class="title">RPA</span>
                Automate your processes with RPA</a>
                <a href="<?php echo $site_url; ?>computer-vision-software-development"><img src="<?php echo $tpl_url; ?>/menu-images/ds-08.svg" class="menuicon" alt="menuicon"><span class="title">Computer vision</span>
                See the future with computer vision</a>
                <a href="<?php echo $site_url; ?>chatgpt-solutions"><img src="<?php echo $tpl_url; ?>/menu-images/ds-09.svg" class="menuicon" alt="menuicon"><span class="title">Chat GPT solutions</span>
                Unlock conversational AI with ChatGPT solutions</a>
                </div>
                </div>
                </div>
                <?php } ?>  
            ...
            <?php 
              ...
              if( !in_array( $mcat, ['ecommerce', 'demand-teams', 'agencies', 'startups', 'devops', 'data-science'] ) ) :
              ?>
            <!-- Solutions -->
            <li class="menu-item-has-children">
                    ...
                    <div class="width-55 detail-list without-icon">
                      ...
                      <div class="dis-flex">
                        <div class="flex-2">
                          ...
                          Digitalized your eLearning experience</a>
                        ...
                        <div class="flex-2">
                          ...
                          <a href="<?php echo $site_url; ?>cms-development"><span class="title">Content Management System (CMS)</span>
                          Cost-effective web content management</a>
            ...
            <?php 
              if( !in_array($mcat, ['devops', 'demand-teams', 'qa-testing', 'enterprises', 'data-science']) ) : ?>
            <!-- Technology -->
            <li class="menu-item-has-children">
                      ...
                      <div class="dis-flex" id="active_Current_Tabs8a">
                        ...
                        <div class="width-35 last-list for-platform">
                          ...
                          <div class="hr-menu-mega">
                            ...
                            <a href="<?php echo $site_url; ?>ai-ml-development-services-company">AI & Machine Learning</a>
