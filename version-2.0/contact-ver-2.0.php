...
<html lang="en">
  <head>
    ...
    <link rel="preload stylesheet" type="text/css" href="../css/contact-form-2.0.min.css" defer />
    <!-- add -->
      ...
      <div class="container">
        <div class="dis-flex form-outer">
          <div class="form-left">
            <div class="bg-voilet">
              <div class="form-box-outer right-box" style="padding-top:40px;">
                <div class="head-txt">
                <div class="logo-box"><a href="<?php echo $site_url; ?>"></a></div>
                  <div class="head-box">
          ...
          <div class="slider-right">
            ...
            <picture>
              <img src="<?=HOST_URL?>images/contact-client-logo-image.svg" class="Client Logo" width="364" height="274">
            </picture>
            <div class="footer-client-box" id="contact-slider">
              <div class="glider-contain contact-slider">
