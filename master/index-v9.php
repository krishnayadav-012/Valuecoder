...
<head>
    ...
    <link rel="preload stylesheet" type="text/css" href="./css/index-v9.css" defer />
    ...
    <section class="award-section padding-t-50 padding-b-120 ">
        <div class="container">
            <div class="top-logo">
                <div class="text">
                    <i><img loading="lazy"
                            src="https://www.valuecoders.com/staging/wp-content/themes/valuecoders/v6.0/images/home-images/star-one.svg"
                    ...
                    <div class="award-section">
                        <picture>
                            <source type="image/webp"
                                srcset="https://www.valuecoders.com/staging/wp-content/themes/valuecoders/v6.0/images/home-images/award-image.png">
                            <img loading="lazy" alt="valuecoders"
                                src="https://www.valuecoders.com/staging/wp-content/themes/valuecoders/v6.0/images/home-images/award-image.png"
            ...
            <div class="friction-inner-part">
                <div class="friction-content-top">
                    ...
                    <p>Scaling isn't just about adding people. It's about diagnosing the
                        friction that turns into delivery debt.</p>
                </div>
