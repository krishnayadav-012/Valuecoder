                ...
                <section class="form-section">
                    ...
                    <div class="input-grid">
                        <div class="input-wrapper">
                            <input type="text" id="fullName" name="fullName" class="form-input" placeholder=" ">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" id="cont_country" name="country" class="form-input has-icon" placeholder=" ">
                    ...
                    <div class="textarea-wrapper">
                        <textarea id="message" name="message" class="form-textarea" rows="5" placeholder=" "></textarea>
