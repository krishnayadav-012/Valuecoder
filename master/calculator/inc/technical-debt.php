<div class="grid grid-cols-1 gap-6 my-20">
            ...
            <div class="bg-white rounded-2xl p-6 md:p-10 shadow-xl border-2 border-black">
                ...
                <div class="bg-black text-white rounded-xl p-8 mb-8 text-center shadow-lg transform transition hover:scale-[1.01]">
                    <p class="text-gray-400 text-sm md:text-base uppercase font-semibold mb-2">Total Technical Debt Cost</p>
                    <p id="totalAnnualCost" class="text-4xl md:text-6xl font-black mb-4">$0</p>
