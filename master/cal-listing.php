...
<head>
  ...
  <title>Business & IT Calculators | ValueCoders</title>
  
  <link rel="stylesheet" href="./css/cal-listing.css">
     ...
     <section class="controls-section">
        <div class="controls-wrapper">
          <div class="filters-group">
            ...
            <ul>
              <li class="active" data-filter="All"><button>All</button></li>
              <li data-filter="Cost"><button>Cost</button></li>
              <li data-filter="ROI"><button>ROI</button></li>
              <li data-filter="Hiring"><button>Hiring</button></li>
              <li data-filter="SaaS"><button>SaaS</button></li>
              <li data-filter="Finance"><button>Finance</button></li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div class="calculator-grid">
          ...
          <div class="card" data-category="Cost" data-popularity="95">
            ...
            <div class="icon-wrapper">
              <img src="./images/white-doller.svg" alt="" class=" hover">
              <img src="./images/dollar-yellow.svg" alt="" class="normal">
            </div>
         ...
         <img src="./images/white-doller.svg" alt="" class=" hover">
          ...
          <div class="card" data-category="Hiring" data-popularity="75">
            <div class="icon-wrapper">
         <img src="./images/white-doller.svg" alt="" class=" hover">
              <img src="./images/dollar-yellow.svg" alt="" class="normal">    </div>
