...
<html lang="en">
  ...
  <body id="themeAdd">
    ...
    <section class="three-column-icon-section padding-t-120 padding-b-120">
      <div class="container">
        <div class="dis-flex top-content">
          <div class="flex-2">
            <h2>Our Software Development <br>Services</h2>
          </div>
          <div class="flex-2">
            <p>Our Software Development team takes care of designing, coding, testing, deployment, and maintenance for any new or continuing development project so we can provide you with the best solution! Whether you are looking for an easy product catalog or an enterprise-level ERP system, we have the right solution for your business. Our experts focus on offering a wide range of services to help you get the most out of your software.</p>
          </div>
        </div>
        <div class="dis-flex col-box-outer margin-t-50">
          <div class="flex-3 box-3 has-anchor">
            <div class="box">
              ...
              <p>With our team of highly experienced development experts, we analyze your idea and target audience to help you create a feasibility plan & strategy based on your business plans to minimize the risks.</p>
              <a href="#">
              </a>
            </div>
          </div>
          <div class="flex-3 box-3 has-anchor">
            <div class="box">
              ...
              <p>We're passionate and dedicated to providing you with tailor-made software that meets your most intricate technical requirements. You share your software requirements with our experts and we custom-develop them for you.</p>
              <a href="#">
              </a>
            </div>
          </div>
          <div class="flex-3 box-3 has-anchor">
            <div class="box">
              ...
              <p>Businesses globally have been confidently outsourcing all their software needs to us for they get high-quality services at affordable prices. Our experienced professionals are dedicated to meeting business needs and exceeding client expectations.</p>
              <a href="#">
              </a>
            </div>
          </div>
    ...
    <section class="tech-stacks padding-t-120 padding-b-120">
      <div class="container">
        <div class="head-txt text-center">
          <h2>Leverage the Technical Expertise of Our ChatGPT Developers</h2>
          <p>Use the specialized knowledge and skills possessed by our ChatGPT developers to benefit from their knowledge and experience in developing AI-powered solutions to automate tasks, improve customer engagement, and provide data-driven insights.</p>
        </div>
        <div class="dis-flex col-box-outer margin-t-50">
    ...
    <section class="technology-section bg-blue-linear">
      <div class="dis-flex">
        <div class="left-box  padding-t-120 padding-b-120">
          <h2>Types of Chatbots we Develop
          </h2>
          <p>Our chatbot app development service includes building advanced chatbots that can handle tasks, automate business growth, and increase ROI at low maintenance costs. We use machine learning, NLP, speech recognition, text analytics, and automation to provide chatbot development solutions.
          </p>
          <p>Our developers have expertise in the development of the following types of chatbots:</p>
          <ul>
            <li>Menu/button-based chatbots</li>
            <li>The hybrid model</li>
            <li>Keyword recognition-based chatbots</li>
            <li>Voice bots</li>
            <li>Linguistic Based (Rule-Based Chatbots)</li>
...
<div class="table-wrap">
  <div class="dis-flex col-box-outer margin-t-100">
    <div class="flex-5 table-list">
      <ul>
        <li class="title clr-white">Feature/Metric</li><li class="">Price</li><li class="">CI/CD Projects</li><li class="">Automated Testing Frameworks</li><li class="">Configuration Management</li><li class="">Containerization &amp; Orchestration</li><li class="m-hdn">Infrastructure as Code (IaC)</li><li class="m-hdn">Monitoring &amp; Logging</li><li class="m-hdn">Incident Management &amp; Response</li><li class="m-hdn">Disaster Recovery Planning</li><li class="m-hdn">Security &amp; Compliance Automation</li><li class="m-hdn">Cost Optimization</li>        <li class="more-spc"><p>Need more information?  <a href="https://www.pixelcrayons.com/staging/contact-us" class="ts">Talk to Sales</a></p>
    ...
    <div class="flex-5 table-list">
      <ul>
        <li class="title">Starter</li><li class="more-txt">$500/month</li><li class="">5</li><li class="">Basic</li><li class="">Basic</li><li class="">x</li><li class="m-hdn">x</li><li class="m-hdn">Basic</li><li class="m-hdn">Basic</li><li class="m-hdn">Basic</li><li class="m-hdn">Basic</li><li class="m-hdn">x</li>        <li class="more-spc"><div class="btn-sec">
    ...
    <section class="experts-talk-first-section consult-sec bg-blue-linear padding-t-70 padding-b-70">
      <div class="container">
        <div class="dis-flex items-center justify-sb">
          <div class="head-txt">
            <h2>Let’s make your software project a success together</h2>
            <p>Book your free consultation with Valuecoders
            </p>
          </div>
          <div class="text-center">
            <a class="green-btn" href="https://www.valuecoders.com/v2wp/contact">Request Now <i class="arrow-icon"></i></a>
          </div>
        </div>
      </div>
    </section>
