            ...
            <li class="menu-item-has-children">
              ...
              <div class="menu-mega container">
                ...
                <div class="container landing-menu" id="landing-menu">
                  <div class="dis-flex">
                    <div class="flex-3">
                      ...
                      Outsourcing, dedicated teams, staff augmentation, hiring Indian developers, etc.</a>
                    ...
                    <div class="flex-3">
                      ...
                      <a href="<?php echo $site_url; ?>startup-product-development"><img src="<?php echo $tpl_url; ?>/menu-images/service_icon7.svg" class="menuicon"><span class="title">For Startups</span>
                ...
                <div class="container w-14 prod-eng" id="m-product-engineering">
                  <div class="dis-flex">
                    <div class="flex-3">
                      ...
                      <a href="<?php echo $site_url; ?>product-ui-ux-design"><img src="<?php echo $tpl_url; ?>/menu-images/prod-engg-icon2.svg" class="menuicon"><span class="title">Product UI/UX Design</span>
                      Choose the right technology and process</a>
                      <a href="<?php echo $site_url; ?>outsource-software-product-development-services"><img src="<?php echo $tpl_url; ?>/menu-images/prod-engg-icon3.svg" class="menuicon"><span class="title">Software Product Development</span>
                ...
                <div class="container w-14 startups" id="m-startups">
                  <div class="dis-flex">
                    <div class="flex-3">
                      ...
                      Deliver software as a service</a>
                      <a href="<?php echo $site_url; ?>startup-consulting-services"><img src="<?php echo $tpl_url; ?>/menu-images/for-startups-icon3.svg" class="menuicon"><span class="title">Product Consulting</span>
                      Assistance from software product conception to release</a>
                    </div>
                    <div class="flex-3">  
                      <a href="<?php echo $site_url; ?>product-ui-ux-design"><img src="<?php echo $tpl_url; ?>/menu-images/for-startups-icon4.svg" class="menuicon"><span class="title">Product UI/UX Design  </span>
                      Choose the right technology and process</a>
                ...
                <div class="container w-14 enterprises" id="m-enterprises">
                  <div class="dis-flex">
                    <div class="flex-3">
                      ...
                      Update your existing web and mobile applications</a>
                      <a href="<?php echo $site_url; ?>application-maintenance"><img src="<?php echo $tpl_url; ?>/menu-images/for-enterprise-icon3.svg" class="menuicon"><span class="title">Application Maintenance & Support</span>
                      Ensure software applications functionality and security</a>
                ...
                <div class="container w-14 agencies" id="m-agencies">
                  <div class="dis-flex">
                    <div class="flex-3">
                      <a href="<?php echo $site_url; ?>white-label-services"><img src="<?php echo $tpl_url; ?>/menu-images/for-agencies-icon1.svg" class="menuicon"><span class="title">Whitelabel Service</span>
