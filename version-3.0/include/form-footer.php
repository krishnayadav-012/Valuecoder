    ...
    <div class=" dis-flex">
        <div class="form-text-cont">
            <div class="user-input">
                <input type="text" autocomplete="off" id="cont_name" placeholder="Full Name" class="input-field input-field-New"
        ...
        <div class="form-text-cont">
            <div class="user-input">
                <input type="text" autocomplete="off" id="cont_email" placeholder="Email Address" class="input-field input-field-New"
        ...
        <div class="form-text-cont">
            <div class="user-input">
                <input type="text" autocomplete="off" class="input-field input-field-New" id="cont_phpne" placeholder="Phone Number"
        ...
        <div class="form-text-cont cont_country_section">
            <div class="user-input">
                <input class="input-field input-field-New input-skype" autocomplete="off" id="cont_country" type="text"
        ...
        <div class="form-text-cont width-full verror">
            <div class="form-control   ">
                <textarea class="input-field  pdding" autocomplete="off" id="user-req" placeholder="Project Brief"
