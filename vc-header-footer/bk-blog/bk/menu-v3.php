        ...
        <div class="wrapper">
            <div class="header-item-left">
                <a href="<?php echo $site_url; ?>" class="brand">
                    <div class="large">
                        <img loading="lazy" src="<?php echo $tpl_url; ?>/images/logo.png" alt="Valuecoders" class="dark-theme-logo" width="301" height="52">
                        <img loading="lazy" src="<?php echo $tpl_url; ?>/images/logo-blue.png" alt="Valuecoders" 
                                    ...
                                    <div class="dis-flex" id="active_Current_Tabs1">
                                        ...
                                        <div class="width-75 for-padding header-menu" id="b2">
                                            ...
                                            <div class="dis-flex" id="active_Current_Tabs3">
                                                ...
                                                <div class="width-33 middle-list">
                                                    <div class="hr-list-item">
													<a href="<?php echo $site_url; ?>backend-development-services" class="title">Backend Development Services</a> <span class="hr-arrow-btn"></span>
                                                    </div>
													<div class="sub-child hr-menu-mega">
                                                ...
                                                <div class="hr-list-item">
                                                    <a href="<?php echo $site_url; ?>frontend-development-services" class="title">Frontend Development Services</a> <span class="hr-arrow-btn"></span>
                                                    </div>
													<div class="sub-child hr-menu-mega">
                                    ...
                                    <div class="dis-flex" id="active_Current_Tabs9">
                                        ...
                                        <div class="width-100 header-menu active for-padding">
                                            <div class="dis-flex last-list" id="active_Current_Tabs9a">
                                                ...
                                                <div class="width-65 hr-menu-mega">
                                                    <div class="width-40">
